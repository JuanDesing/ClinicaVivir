 ...
 * @author Rojeru San
 */
public class ErrorAlertdoctor extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public ErrorAlertdoctor(JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//            JOptionPane.showMessageDialog(null, "debes digitar el idd!!!!!!!!!!!!11");
            WarningAlertCerrar wa = new WarningAlertCerrar(new FDoctor(), true);
                wa.titulo.setText("DEBES DIGITAR LA CÉDULA!!!");
...
//                JOptionPane.showMessageDialog(null, "debes digitar el idd!!!!!!!!!!!!11");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ErrorAlertdoctor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ErrorAlertdoctor dialog = new ErrorAlertdoctor(new javax.swing.JFrame(), true);
